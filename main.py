...
class SDTemplatesApp:
    def __init__(self, root):
        ...
        self.json_path = os.path.join(self.script_dir, resource_path('templates.json'))
        self.pictures_dir = os.path.join(self.script_dir, resource_path('Pictures'))
        self.icon_path = os.path.join(self.script_dir, resource_path('app.ico'))
